...
//    }
    ...
    @Test
    fun `AH - Purge User Messages`() = testScope.runTest {
        // GIVEN
        val testUserData = TestData.users.first()
        val testCreateUserInputRequest = CreateUpdateUserRequest(
            userid = RandomString.make(16),
        ...
        try {
            ...
            // THEN
            println("`AH - Purge User Messages`()")
            assertTrue { true }
        } catch (err: SportsTalkException) {
            err.printStackTrace()
            fail(err.message)
    ...
    @Test
    fun `AH-ERROR-403 - Purge User Messages - NO Local Purge Permission`() = testScope.runTest {
        // GIVEN
        val testUserData = TestData.users.first()
        val testCreateUserInputRequest = CreateUpdateUserRequest(
            userid = RandomString.make(16),
        ...
        try {
            ...
            err.printStackTrace()
            println(
                "`AH-ERROR-403 - Purge User Messages - NO Local Purge Permission`() -> testActualResult = \n" +
                        json.encodeToString(
                            SportsTalkException.serializer(),
                            err
                        )
    ...
    @Test
    fun `AH-ERROR-404 - Purge User Messages - Purging User Not Found`() = testScope.runTest {
        // GIVEN
        val testUserData = TestData.users.first()
        val testCreateUserInputRequest = CreateUpdateUserRequest(
            userid = RandomString.make(16),
        ...
        try {
            ...
            err.printStackTrace()
            println(
                "`AH-ERROR-404 - Purge User Messages - Purging User Not Found`() -> testActualResult = \n" +
                        json.encodeToString(
                            SportsTalkException.serializer(),
                            err
                        )
